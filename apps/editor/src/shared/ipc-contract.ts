...
export const recoveryOpenRequestSchema = z
  .object({ startup: z.boolean().optional() })
  .strict()
  .optional();
...
export interface MarionetteApi {
  ...
  openRecovery(options?: { readonly startup?: boolean }): Promise<IpcResult<FileOpenResponse>>;
